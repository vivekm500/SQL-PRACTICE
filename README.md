...
The repository is maintained as a **practice + submission-ready archive** of SQL concepts including database creation, table design, relationships, and queries.
...
4. Execute the **`.sql` file** in:
   - MySQL
   - MariaDB
   - Any compatible SQL environment
